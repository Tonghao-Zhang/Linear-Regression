...
lm6.5
cor(data7.24$X1,data7.24$X2)
```

The coefficent  $\beta_1$ from part a is identical to that of 6.5.
...
Yes, SSR($X_1$) equals to SSR($X_1|X_2$).
...
index<-c(1,2,3)
data3.plot<-data.frame(muB1=muB1,muB2=muB2,index=index)
ggplot(data3.plot,aes(x=index,y=muB1))+geom_point()
ggplot(data3.plot,aes(x=index,y=muB2))+geom_point()
```
...
lm3.b
data3.plot$muB1<-c(12.044+5.667,12.044+5.667*2,12.044+5.667*3)
data3.plot$muB2<-c(12.044+5.667,12.044+5.667*2,12.044+5.667*3)-12.589
ggplot(data3.plot,aes(x=index,y=muB1))+geom_point()
ggplot(data3.plot,aes(x=index,y=muB2))+geom_point()
```
...
lm3.c
data3.plot$muB1<-c(30.633,30.633+4.667,30.633+11.333)
data3.plot$muB2<-c(30.633,30.633+4.667,30.633+11.333)-12.589
ggplot(data3.plot,aes(x=index,y=muB1))+geom_point()
ggplot(data3.plot,aes(x=index,y=muB2))+geom_point()
```
